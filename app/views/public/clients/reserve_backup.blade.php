    ...
    <div class="reservation-form">
		...
		<div class="reservation-holder">
			<div class="half">
				...
				{{ Form::text('home_address',join(" ",json_decode($user->home_address)),array('placeholder' => 'Home Address','class' => 'control-input','readonly' => true)) }}
			</div>
			<div class="half last">
				<label>Work Address:</label>
				{{ Form::text('work_address',join(" ",json_decode($user->work_address)),array('placeholder' => 'Work Address','class' => 'control-input','readonly' => true)) }}
			</div>
			<div style="clear:both;"></div>
		</div>
		<div class="reservation-holder">
