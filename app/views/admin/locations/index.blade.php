    ...
    <div class="col-lg-12">
        <div class="panel panel-default">
            <div class="panel-heading">
                ...
                <input type="hidden" id="create_location" value="{{ URL::route('admin.locations.create') }}"/>
            </div>
            <div class="panel-body">
                <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered" id="xdatatable" width="100%">
                    ...
                    <tr>
                        ...
                        <td>
                            {{ link_to_route('admin.locations.edit', 'Edit', array($location->id), array('class' => 'btntable DTTT_button pull-left')) }}
